...
- **LeetCode**
  ...
  - **weekly contest 162**
    - [Cells with odd values in a matrix](https://gitlab.com/mvochoa/hackerrank/tree/master/LeetCode/weekly-contest-162/cells-with-odd-values-in-a-matrix) - *76 seconds ago*
- **Tutorials**
  - **30 Days of Code**
